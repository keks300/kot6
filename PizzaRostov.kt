class PizzaRostov (
    ...
    override fun drinkSale() {
     ...
     override fun offerSauce(){
        ...
        if (c == "1") {
            ...
            println("С вас 50 рублей за кофе\n")
            ...
            println("С вас 65 рублей за кофе\n")
            when{
    ...
    override fun neapolitanPizzaSale() {
        ...
        println("Спасибо за покупку неаполитической пиццы в Ростове-на-Дону")
    }

    override fun romanPizzaSale() {
        romanPizzaCount++
        println("Спасибо за покупку римской пиццы в Ростове-на-Дону")
    }

    override fun sicilianPizzaSale() {
        sicilianPizzaCount++
        println("Спасибо за покупку сицилийской пиццы в Ростове-на-Дону")
    }

    override fun tyroleanPizzaSale() {
        tyroleanPizzaCount++
        println("Спасибо за покупку Тирольской пиццы в Ростове-на-Дону")
    }
